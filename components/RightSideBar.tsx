            ...
            <section className='banks'>
                <div className='flex w-full justify-between'>
                    ...
                    <Link href="/" className='flex gap-2'>
                        ...
                        <h2 className='text-semibold text-14 text-gray-600'>Add Bank</h2>
                    </Link>
                </div>
                ...
                {banks?.length > 0 && (
                    <div className='relative flex flex-1 flex-col justify-center items-center gap-5'>
                        <div className='relative z-10'>
                            <BankCard key={banks[0].$id} account={banks[0]} userName={`${user.firstName} ${user.lastName}`} showBalance={false}></BankCard>
                        </div>
                        {banks[1] && (
